<div class="card m-3">
    ...
    <div class="card-body py-2">
        <a href="add/<?php echo $this->route['id']; ?>" class="btn btn-primary float-right">Добавить схему</a>
    </div>
    ...
    <table class="table table-bordered table-hover table-sm text-center">
        ...
        <tr class="table-secondary">
            ...
            <th class="align-middle">Наименование исполнительной схемы</th>
            <th class="align-middle">Номер схемы</th>
        ...
        <tr>
            ...
            <td class="align-middle"><?php echo $val['name_drawing'];?></td>
            <td class="align-middle"><?php echo $val['number_drawing'];?></td>
