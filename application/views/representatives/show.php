<div class="card m-3">
    ...
    <div class="card-body py-2">
        <a href="add/<?php echo $this->route['id']; ?>" class="btn btn-primary float-right">Добавить представителя</a>
    </div>
    ...
    <table class="table table-bordered table-hover table-sm text-center">
        ...
        <tr class="table-secondary">
            ...
            <th class="align-middle">Наименование строительной организации</th>
            <th class="align-middle">Фамилия И.О.</th>
        </tr>
        </thead>
        ...
        <tr>
            ...
            <td class="align-middle"><?php echo $val['position'];?></td>
            <td class="align-middle"><?php echo $val['name_orgs'];?></td>
            <td class="align-middle"><?php echo $val['fio'];?></td>
            <?php endif;?>
            <?php endforeach;?>
        </tr>
        </tbody>
