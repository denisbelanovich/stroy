<div class="card m-3">
    ...
    <div class="card-body py-2">
        <a href="add/<?php echo $this->route['id']; ?>" class="btn btn-primary float-right">Добавить проект</a>
    </div>
    ...
    <table class="table table-bordered table-hover table-sm text-center">
        <thead>
            <tr class="table-secondary">
                ...
                <th class="align-middle">Наименование проектной организации</th>
                <th class="align-middle">Шифр проекта</th>
                <th class="align-middle">Номер листа и изменения</th>
                <th class="align-middle" style="width: 170px">Дата утверждения</th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <?php if($this->route['id'] == $val['objects_id']): ?>
                <tr>
                    ...
                    <td class="align-middle"><?php echo $val['name_porg'];?></td>
                    <td class="align-middle"><?php echo $val['cypher'];?></td>
                    <td class="align-middle"><?php echo $val['number_list'];?></td>
