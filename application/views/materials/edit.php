        ...
        <div class="mx-auto col-lg-9">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 text-center">Редактировать материал</h4>
                </div>
                <div class="card-body">
                    <form class="form" role="form" method="post" action="<?=$_SERVER['REQUEST_URI']?>">
                        <div class="form-group">
                            ...
                            <input id="name_material" name="name_material" type="text" class="form-control" value="<?php echo htmlspecialchars($data['name_material'], ENT_QUOTES); ?>"/>
                        </div>
                        <div class="form-group">
                            <label for="name_document" class="control-label">Наименование документа о качестве:</label>
                            <input id="name_document" name="name_document" type="text" class="form-control" value="<?php echo htmlspecialchars($data['name_document'], ENT_QUOTES); ?>"/>
                        </div>
                        <div class="form-group">
                            <label for="number" class="control-label">Номер документа о качестве:</label>
                            <input id="number" name="number" type="text" class="form-control" value="<?php echo htmlspecialchars($data['number'], ENT_QUOTES); ?>"/>
                        </div>
                        <div class="form-group">
