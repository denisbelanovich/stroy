        ...
        <div class="mx-auto col-lg-9">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 text-center">Редактировать объект строительства</h4>
                </div>
                <div class="card-body">
                <form class="form" role="form" method="post" action="<?=$_SERVER['REQUEST_URI']?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="name" name="name" class="form-control" rows="5"><?php echo htmlspecialchars($data['name'], ENT_QUOTES); ?></textarea>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4"></div>
                        <label class="control-label col-md-2">Статус:</label>
                        <select class="form-control form-select-sm col-md-5" name="status">
                            <option selected><?php echo htmlspecialchars($data['status'], ENT_QUOTES); ?></option>
