<div class="card m-3">
    ...
    <div class="card-body py-2">
        <a href="add/<?php echo $this->route['id']; ?>" class="btn btn-primary float-right">Добавить протокол</a>
    </div>
    ...
    <table class="table table-bordered table-hover table-sm text-center">
        ...
        <tr class="table-secondary">
            ...
            <th class="align-middle">Наименование протокола</th>
            <th class="align-middle">Номер протокола</th>
        ...
        <tr>
            ...
            <td class="align-middle"><?php echo $val['name_protocol'];?></td>
            <td class="align-middle"><?php echo $val['number_protocol'];?></td>
